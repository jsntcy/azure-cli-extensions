...
def update_databox_job(client,
    ...
    body.setdefault('details', {}).setdefault('contact_details', {})['email_list'] = contact_details.email_list if email_list is None else email_list
    body.setdefault('details', {}).setdefault('shipping_address', {})['street_address1'] = shipping_address.street_address1 if street_address1 is None else street_address1  # str
    body.setdefault('details', {}).setdefault('shipping_address', {})['street_address2'] = shipping_address.street_address2 if street_address2 is None else street_address2  # str
    body.setdefault('details', {}).setdefault('shipping_address', {})['street_address3'] = shipping_address.street_address3 if street_address3 is None else street_address3  # str
    body.setdefault('details', {}).setdefault('shipping_address', {})['city'] = shipping_address.city if city is None else city  # str
    body.setdefault('details', {}).setdefault('shipping_address', {})['state_or_province'] = shipping_address.state_or_province if state_or_province is None else state_or_province  # str
    body.setdefault('details', {}).setdefault('shipping_address', {})['country'] = shipping_address.country if country is None else country  # str
    body.setdefault('details', {}).setdefault('shipping_address', {})['postal_code'] = shipping_address.postal_code if postal_code is None else postal_code  # str
    body.setdefault('details', {}).setdefault('shipping_address', {})['company_name'] = shipping_address.company_name if company_name is None else company_name  # str
